...
SlowEffect::SlowEffect(float slowRatio, int duration)
    : StatusEffectBase{EffectIds::kSlow, "Slow", std::make_optional(duration), {EffectTags::kDebuff, EffectTags::kStatMod, EffectTags::kFrost}},
      m_slowRatio{slowRatio}
{
}

Stats SlowEffect::modifyStatsPct(Stats base) const
{
